...
public class RealTime {
    ...
    private static final boolean isWinter;
    private static final float mcf;
    ...
    static {
        ...
        switch (cal.get(Calendar.MONTH)) {
            ...
            case 9, 10, 11 -> {
                mcf = (365 - cal.get(Calendar.DAY_OF_YEAR)) / 91.5f;
                isWinter = true;
            }
            case 3, 4, 5 -> {
            ...
            case 6, 7, 8 -> {
                mcf = (cal.get(Calendar.DAY_OF_YEAR) - 183) / 91.5f;
                isWinter = false;
            }
            default -> {
                isWinter = true;
    ...
    public static int getMCTime() {
        ...
        if (isWinter) {
            return switch (tm / 1000) {
                case 0, 1, 2, 3, 4, 5, 6, 7 -> 18000 + (int) (tm * (0.75f + (0.25f * mcf)));
                case 8, 9, 10, 11 -> 6000 - (int) ((12000 - tm) * (1.5f - (0.5f * mcf)));
                case 12, 13, 14, 15, 16, 17, 18, 19 -> 6000 + (int) ((tm - 12000) * (1.5f - (0.5f * mcf)));
                case 20, 21, 22, 23 -> 18000 - (int) ((24000 - tm) * (0.75f + (0.25f * mcf)));
                default -> 6000;
            };
        } else {
            return switch (tm / 1000) {
